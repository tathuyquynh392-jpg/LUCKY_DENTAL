...
export const ServiceManagement = () => {
  ...
  const handleOpenAdd = () => {
    setFormData({ id: '', name: '', description: '', price: 500000, duration: '30 phút', status: 'Hoạt động' });
  ...
  return (
    <div>
            ...
            <tbody>
              {paginatedServices.map(srv => (
                <tr key={srv.id}>
                  ...
                  <td style={{ color: '#64748b', fontSize: '0.85rem' }}>{srv.description}</td>
      ...
      {/* Edit Modal */}
      <Modal isOpen={isEditModalOpen} onClose={() => setIsEditModalOpen(false)} title="Sửa Dịch Vụ"
